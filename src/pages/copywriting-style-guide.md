...
我们的公司名称是「联合互娱」（英文：UnionMusic）。注意这是两个单词的合成词，中间沒有空格（參考：GitHub）。如作为 URL 的一部分，应该使用全小写的「unionmusic」。
...
* 英文与非标点的中文之间需要有一个空格，如「我们使用 GitHub 作为我们的代码管理平台」而不是「我们使用GitHub作为我们的代码管理平台用」。[^1]
